...
test("test open https://www.saucedemo.com/ then login failed by wrong password", async ({
  page,
}) => {
...
test("test open https://www.saucedemo.com/ then login failed by not fill user name", async ({
  page,
}) => {
  await page.goto("https://www.saucedemo.com/");
...
test("test open https://www.saucedemo.com/ then login failed by locked out user", async ({
  page,
}) => {
  await page.goto("https://www.saucedemo.com/");
